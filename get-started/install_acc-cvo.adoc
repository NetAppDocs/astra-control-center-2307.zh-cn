...
已安装并配置Asta Trident 22.10或更高版本、并将NetApp ONTAP 9.8或更高版本用作存储后端[AWS注册表]]
...
| Astra Trident (在NetApp BlueXP中作为Kubernetes集群发现的一部分安装、以前称为Cloud Manager)  a| 
已安装并配置Astra Trident 22.10或更高版本、并将NetApp ONTAP 9.8或更高版本用作存储后端[[gcp-reRegistry ]
...
已安装并配置Asta Trident 22.10或更高版本、NetApp ONTAP 9.8或更高版本将用作存储后端[[azure-Registry ]]
